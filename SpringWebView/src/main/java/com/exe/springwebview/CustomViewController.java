...
public class CustomViewController {
	...
	public String upload(MultipartHttpServletRequest request, String str) throws Exception {
		...
		String path = request.getSession().getServletContext().getRealPath("/WEB-INF/files"); // 다운 위치 지정
		...
		// getServletContext().getRealPath("/resources/image"); -> resources 안에 image폴더
		// 만들었을 때
		...
		// <resources mapping="/resources/**" location="/resources/"> -이건 resources 안에
		// image폴더 만들었을 때
